...
\section{OpenAL}
OpenAL was developed by Creative labs (maker of soundcards) to provide a games-focussed interface allowing sounds and listeners to be positioned in space.  Then effects including time delay, volume degragation, and doppler shifts are implemented to compute the sound at the listener location.
