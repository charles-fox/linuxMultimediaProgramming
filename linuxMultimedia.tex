...
to connect. A wifi switch is a different device from a domestic combined
...
between the local and LAN networks. This machine is called the gateway.
It can be useful to use this machine to host other network services
too, as below.

To restart the network system use

\emph{service network restart}
...
See tools: nslookup, whois, host, ifconfig (many hidden options).
