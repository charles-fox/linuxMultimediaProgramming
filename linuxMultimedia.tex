...
NVidia's ISA is called PTX (Parallel Thread eXecution) and is documented here,
...
\begin{lstlisting}
usermod -l ouruser ourusernew    #change user name (preserve uID number)
...
Swapping keys is often useful as a lab machine may have unusual form factor and keyboard, or we might just want to make CAPS into ESCAPE to use in vi, by adding to bashrc:
