...
MuseScore can be used as a command line tool to generate graphical images of scores from MusicXML files, (I think this is how wikipedia converts MusicXML musical fragments into png files for display on its pages). Example png generation:

MuseScore.exe -s -m -r 100 musicXML.xml -o musicXML.png
